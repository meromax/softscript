...
Calendar.cellClick = function(el, ev) {
	...
	day_num=date.getDay();
	if(day_num==0) day_name='Sun';
	if(day_num==1) day_name='Mon';
	if(day_num==2) day_name='Tue';
	if(day_num==3) day_name='Wed';
	if(day_num==4) day_name='Thu';
	if(day_num==5) day_name='Fri';
	if(day_num==6) day_name='Sat';

			var piu = cal.params;
			fld=piu.inputField.id;
			
			element_id=fld+'tt';
			
	document.getElementById(element_id).value = day_name;
