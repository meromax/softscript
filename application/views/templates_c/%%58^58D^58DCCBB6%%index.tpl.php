<?php /* Smarty version 2.6.18, created on 2014-02-06 14:48:02
         compiled from admin/deals/settings/index.tpl */ ?>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <select id="menu" name="menu" class="span3 m-wrap">
                                                <option value="1" <?php if ($this->_tpl_vars['dealSettings']->menu == 1): ?>selected="selected"<?php endif; ?>>ДА</option>
                                                <option value="0" <?php if ($this->_tpl_vars['dealSettings']->menu == 0): ?>selected="selected"<?php endif; ?>>НЕТ</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <select id="main" name="main" class="span3 m-wrap">
                                                <option value="1" <?php if ($this->_tpl_vars['dealSettings']->main == 1): ?>selected="selected"<?php endif; ?>>ДА</option>
                                                <option value="0" <?php if ($this->_tpl_vars['dealSettings']->main == 0): ?>selected="selected"<?php endif; ?>>НЕТ</option>
                                            </select>
                                        </div>
                                    </div>
