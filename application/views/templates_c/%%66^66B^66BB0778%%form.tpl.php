<?php /* Smarty version 2.6.18, created on 2014-01-29 18:45:37
         compiled from orders/form.tpl */ ?>
<!-- Shopping Cart -->
                    ...
                    <div class="span10 offset1">
                        ...
                        <div style="padding-left: 274px;">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="name" id="name" class="span4" value="<?php echo $this->_tpl_vars['userInfo']['first_name']; ?>
">
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="email" id="email" class="span4" value="<?php echo $this->_tpl_vars['userInfo']['email']; ?>
">
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="tel" name="phone" id="phone" class="span4" value="<?php echo $this->_tpl_vars['userInfo']['phone']; ?>
">
                                </div>
                            </div>
                        </div>
