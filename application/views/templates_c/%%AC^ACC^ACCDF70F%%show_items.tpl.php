<?php /* Smarty version 2.6.18, created on 2013-10-31 23:51:10
         compiled from actions/show_items.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'stripslashes', 'actions/show_items.tpl', 10, false),array('modifier', 'strip_tags', 'actions/show_items.tpl', 10, false),array('modifier', 'date_format', 'actions/show_items.tpl', 11, false),)), $this); ?>
...
?>
            ...
            <div class="item" style="border-top: 0px solid #cbcbcb; padding: 0px 0px 0px 0px;">
                <div class="name"><a href="/actions/view/<?php echo $this->_tpl_vars['item']['link']; ?>
"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['item']['title'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)))) ? $this->_run_mod_handler('strip_tags', true, $_tmp) : smarty_modifier_strip_tags($_tmp)); ?>
                ...
                <div class="text"><a href="/actions/view/<?php echo $this->_tpl_vars['item']['link']; ?>
...
?>
                        <?php if ($this->_tpl_vars['page_num'] == $this->_sections['item']['index']): ?>
                            ...
                            <?php else: ?>
                            <a href="/actions/page/<?php echo $this->_sections['item']['index']; ?>
