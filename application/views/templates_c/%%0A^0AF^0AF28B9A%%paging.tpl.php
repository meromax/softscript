<?php /* Smarty version 2.6.18, created on 2014-02-04 20:17:43
         compiled from admin/news/paging.tpl */ ?>
        ...
        <div class="pagination" style="margin-top: 15px; margin-bottom: 0px;">
            <ul>
                <?php if ($this->_tpl_vars['page'] == 1): ?>
                    ...
                    <?php else: ?>
                    <li class="prev"><a href="/admin/news/page/<?php echo $this->_tpl_vars['page']-1; ?>
...
?>
                    <?php if ($this->_tpl_vars['page'] == $this->_sections['item']['index']): ?>
                        ...
                        <?php else: ?>
                        <li><a href="/admin/news/page/<?php echo $this->_sections['item']['index']; ?>
"><?php echo $this->_sections['item']['index']; ?>
                ...
                <?php if ($this->_tpl_vars['page'] == $this->_tpl_vars['countpage']): ?>
                    ...
                    <?php else: ?>
                    <li class="next"><a href="/admin/news/page/<?php echo $this->_tpl_vars['page']+1; ?>
