<?php /* Smarty version 2.6.18, created on 2014-02-05 20:27:55
         compiled from admin/deals/add_modify_item.tpl */ ?>
...
<div class="row-fluid">
    <div class="span12">
        ...
        <h3 class="page-title">
            <?php if ($this->_tpl_vars['action'] == 'modify'): ?>Добавление<?php else: ?>Изменение<?php endif; ?> акции <small>&nbsp;</small>
        </h3>
        ...
        <ul class="breadcrumb">
            ...
            <li>
                <a href="javascript:void(0);"><?php if ($this->_tpl_vars['action'] == 'modify'): ?>Добавление<?php else: ?>Изменение<?php endif; ?> акции</a>
            </li>
        </ul>
...
$this->_smarty_include(array('smarty_include_tpl_file' => 'admin/deals/tab_general.tpl', 'smarty_include_vars' => array()));
...
unset($_smarty_tpl_vars);
 ?>
                                        ...
                                        <div class="tab-pane active" id="tab_1_2" style="padding-left: 10px; padding-top: 20px;">
                                            <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => 'admin/deals/tab_prices.tpl', 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
                                        </div>
                                        ...
                                        <div class="tab-pane active" id="tab_1_3" style="padding-left: 10px; padding-top: 20px;">
                                            <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => 'admin/deals/tab_datatime.tpl', 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
                                        </div>
