<?php /* Smarty version 2.6.18, created on 2013-03-10 18:46:29
         compiled from sections/template_archive_section_brand_page.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'stripslashes', 'sections/template_archive_section_brand_page.tpl', 2, false),array('modifier', 'strip_tags', 'sections/template_archive_section_brand_page.tpl', 2, false),array('modifier', 'truncate', 'sections/template_archive_section_brand_page.tpl', 5, false),)), $this); ?>
<div class="topTextBlock" style="min-height: 120px;">
    <div class="pageTitle">Архив :: <?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['item']['title'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)))) ? $this->_run_mod_handler('strip_tags', true, $_tmp) : smarty_modifier_strip_tags($_tmp)); ?>
</div>
...
$this->_smarty_include(array('smarty_include_tpl_file' => 'sections/archive_brands.tpl', 'smarty_include_vars' => array()));
...
?>
            ...
            <?php else: ?>
                <a href="/archive/sec/<?php echo $this->_tpl_vars['activeLeftSection']; ?>
/brand/<?php echo $this->_tpl_vars['brandLink']; ?>
...
"><div class="point"><?php echo $this->_sections['item']['index']; ?>
    ...
    <div class="archive">
        <a href="/catalog/sec/<?php echo $this->_tpl_vars['secLink']; ?>
/brand/<?php echo $this->_tpl_vars['brandLink']; ?>
/page/1">Архив товаров</a>
    </div>
