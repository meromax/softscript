<?php /* Smarty version 2.6.18, created on 2014-02-10 11:20:36
         compiled from admin/deals/sections/items_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'stripslashes', 'admin/deals/sections/items_list.tpl', 54, false),)), $this); ?>
...
?>
                                <tr>
                                    ...
                                    <td class="span3" style="text-align: center; vertical-align: middle;">
                                        <a href="/admin/deals/categories/section_id/<?php echo $this->_tpl_vars['item']['id']; ?>
/spage/<?php echo $this->_tpl_vars['page']; ?>
/page/0">Изменить</a>
                                    </td>
                                    <td class="span3" style="text-align: center; vertical-align: middle;">
                                        <a href="/admin/deals/modifysection/id/<?php echo $this->_tpl_vars['item']['id']; ?>
">Изменить</a>
                                        &nbsp;|&nbsp;
                                        <a href="/admin/deals/deletesection/id/<?php echo $this->_tpl_vars['item']['id']; ?>
...
$this->_smarty_include(array('smarty_include_tpl_file' => 'admin/deals/sections/paging.tpl', 'smarty_include_vars' => array()));
