<?php /* Smarty version 2.6.18, created on 2014-02-04 19:22:58
         compiled from profile/products/products_general.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'stripslashes', 'profile/products/products_general.tpl', 7, false),array('modifier', 'strip_tags', 'profile/products/products_general.tpl', 7, false),)), $this); ?>
...
" class="span7" placeholder="Введите название вашего товара здесь..." onchange="setLink();" onkeyup="setLink();" onkeypress="setLink();">
</p>
...
" class="span7" placeholder="Здесь появиться ссылка в транслите после ввода названия товара..." readonly="readonly">
</p>

<p class="push-down-10">
    <label for="author">Короткое описание:</label>
    <input type="text" id="addinfo" name="addinfo" value="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['item']['addinfo'])) ? $this->_run_mod_handler('strip_tags', true, $_tmp) : smarty_modifier_strip_tags($_tmp)))) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
"  class="span7" placeholder="Введите короткое описание здесь...">
</p>

<p class="push-down-10">
    <label for="author">Полное описание<span class="red-clr bold">*</span>:</label>
    <textarea tabindex="4" id="description" name="description" rows="10" class="span7 ckeditor" placeholder="Введите полное описание здесь..."><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['description'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
</textarea>
</p>
...
" maxlength="7" placeholder="Введите цену товара..." onkeyup="calculatePercents();">
</p>
...
" maxlength="7" placeholder="Введите старую цену товара..." onkeyup="calculatePercents();">
</p>
...
" readonly="readonly" maxlength="3" class="span1" style="text-align: center;" onclick="calculatePercents();">
</p>
...
<p class="push-down-10">
 ...
 "maxlength="3" class="span1" style="text-align: center;" value="0">
</p>