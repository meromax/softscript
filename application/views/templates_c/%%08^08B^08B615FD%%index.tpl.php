<?php /* Smarty version 2.6.18, created on 2014-01-24 17:45:11
         compiled from search/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'strip_tags', 'search/index.tpl', 43, false),array('modifier', 'stripslashes', 'search/index.tpl', 43, false),)), $this); ?>
<!--  ==========  -->
<!--  = Breadcrumbs =  -->
<!--  ==========  -->
...
, <?php echo $this->_tpl_vars['max_price']; ?>
            ...
            <!--  = Main content =  -->
            <!--  ==========  -->
            <section <?php if ($this->_tpl_vars['products']): ?>class="span9"<?php else: ?>class="span12"<?php endif; ?>>
