<?php /* Smarty version 2.6.18, created on 2013-12-25 00:23:27
         compiled from sections/catalog_sections2.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'strip_tags', 'sections/catalog_sections2.tpl', 12, false),array('modifier', 'stripslashes', 'sections/catalog_sections2.tpl', 12, false),)), $this); ?>
...
/page/1" style="color: #464e57;"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['currCategory']['title'])) ? $this->_run_mod_handler('strip_tags', true, $_tmp) : smarty_modifier_strip_tags($_tmp)))) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
            ...
            <?php if ($this->_tpl_vars['currSection'] && $this->_tpl_vars['currSection']['description'] != '&nbsp;'): ?>
            <div class="pageText" style="background: #fff; padding: 10px 10px 10px 10px; border: 1px solid #6b8098; margin-top: 20px;">
                <?php echo ((is_array($_tmp=$this->_tpl_vars['currSection']['description'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
...
_middle.jpg" width="211" height="163" title="<?php echo $this->_tpl_vars['prod']['image_title']; ?>
" />
                        <?php else: ?>
...
?>
                    <?php if ($this->_tpl_vars['page_num'] == $this->_sections['item']['index']): ?>
                        ...
                        <?php else: ?>
                        <a href="/section/<?php echo $this->_tpl_vars['activeLeftSection']; ?>
