<?php /* Smarty version 2.6.18, created on 2014-02-07 17:11:13
         compiled from admin/products/products_recommended.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'stripslashes', 'admin/products/products_recommended.tpl', 22, false),array('modifier', 'strip_tags', 'admin/products/products_recommended.tpl', 22, false),)), $this); ?>
<div>
...
_small.jpg" width="88" height="62">
                    ...
                    <td style="text-align: center; padding-top: 11px; vertical-align: middle;">
                        <button type="button" class="btn green" onclick="addPR('<?php echo $this->_tpl_vars['pr']['id']; ?>
');"><i class="icon-ok"></i> Добавить</button>
                    </td>
                </tr>
