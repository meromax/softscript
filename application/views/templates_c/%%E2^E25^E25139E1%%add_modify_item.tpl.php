<?php /* Smarty version 2.6.18, created on 2014-02-06 14:47:40
         compiled from admin/deals/companies/add_modify_item.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'stripslashes', 'admin/deals/companies/add_modify_item.tpl', 54, false),)), $this); ?>
<div class="container-fluid">
    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            <h3 class="page-title">
                <?php if ($this->_tpl_vars['action'] == 'modifycompany'): ?>Изменение<?php else: ?>Добавление<?php endif; ?> компании <small>&nbsp;</small>
            </h3>
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="/admin/deals/companies/page/1">Компании</a>
                    <i class="icon-angle-right"></i>
                </li>
                <li>
                    <a href="javascript:void(0);"><?php if ($this->_tpl_vars['action'] == 'modifycompany'): ?>Изменение<?php else: ?>Добавление<?php endif; ?> компании</a>
                </li>
            </ul>
        </div>
    </div>
            ...
            <div class="span12">
                ...
                <div class="portlet box grey">
                    <div class="portlet-title">
                        <div class="caption"><?php if ($this->_tpl_vars['action'] == 'modifycompany'): ?><i class="icon-pencil"></i> Изменение<?php else: ?><i class="icon-plus"></i> Добавление<?php endif; ?> компании</div>
                    </div>
