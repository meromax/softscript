<?php /* Smarty version 2.6.18, created on 2014-02-06 18:24:51
         compiled from admin/articles/sections/add_modify_item.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'stripslashes', 'admin/articles/sections/add_modify_item.tpl', 50, false),)), $this); ?>
...
" name="article_form" id="section_form" enctype="multipart/form-data">
...
unset($_smarty_tpl_vars);
 ?>
                                    ...
                                    <div class="form-actions" style="padding-left: 20px;">
                                        ...
                                        <button type="button" class="btn" onclick="document.location.href='/admin/articles/sections/page/1'"><i class="icon-undo"></i> Отмена</button>
                                    </div>
                                </form>
                            </div>
                        </div>
