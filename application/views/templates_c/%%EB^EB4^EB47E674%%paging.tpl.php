<?php /* Smarty version 2.6.18, created on 2014-01-28 20:17:33
         compiled from admin/banners/paging.tpl */ ?>
    ...
    <div class="span12">
        <div class="pagination" style="margin-top: 15px; margin-bottom: 0px;">
            <ul>
                ...
                <?php else: ?>
                    <li class="prev"><a href="/admin/banners/index/page/<?php echo $this->_tpl_vars['page']-1; ?>
...
?>
                ...
                <?php else: ?>
                    <li><a href="/admin/banners/index/page/<?php echo $this->_sections['item']['index']; ?>
"><?php echo $this->_sections['item']['index']; ?>
                ...
                <?php else: ?>
                    <li class="next"><a href="/admin/banners/index/page/<?php echo $this->_tpl_vars['page']+1; ?>
