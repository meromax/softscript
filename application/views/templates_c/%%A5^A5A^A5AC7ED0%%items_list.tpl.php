<?php /* Smarty version 2.6.18, created on 2014-02-06 19:37:46
         compiled from admin/articles/sections/items_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'stripslashes', 'admin/articles/sections/items_list.tpl', 50, false),)), $this); ?>
    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="/admin/articles/sections/page/1">Разделы статей</a></li>
            </ul>
            ...
            <div class="span12">
                <div class="portlet box grey">
                    <div class="portlet-title">
                        ...
                        <div class="actions">
                            <a href="/admin/articles/addsection" class="btn blue"><i class="icon-plus"></i> Добавить</a>
                        </div>
                    </div>
...
?>
                                <tr>
                                    ...
                                    <td class="span3" style="text-align: center; vertical-align: middle;">
                                        <a href="/admin/articles/categories/section_id/<?php echo $this->_tpl_vars['item']['id']; ?>
/spage/<?php echo $this->_tpl_vars['page']; ?>
/page/0">Изменить</a>
                                    </td>
                                    <td class="span3" style="text-align: center; vertical-align: middle;">
                                        <a href="/admin/articles/modifysection/id/<?php echo $this->_tpl_vars['item']['id']; ?>
">Изменить</a>
                                        &nbsp;|&nbsp;
                                        <a href="/admin/articles/deletesection/id/<?php echo $this->_tpl_vars['item']['id']; ?>
...
$this->_smarty_include(array('smarty_include_tpl_file' => 'admin/articles/sections/paging.tpl', 'smarty_include_vars' => array()));
