<?php /* Smarty version 2.6.18, created on 2014-02-06 14:46:10
         compiled from admin/deals/categories/items_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'stripslashes', 'admin/deals/categories/items_list.tpl', 46, false),array('modifier', 'strip_tags', 'admin/deals/categories/items_list.tpl', 47, false),)), $this); ?>
    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="/admin/deals/categories/section_id/<?php echo $this->_tpl_vars['section_id']; ?>
/spage/1/page/1">Категории</a>
                </li>
            </ul>
            ...
            <div class="span9">
                <div class="portlet box grey">
                    <div class="portlet-title">
                        ...
                        <div class="actions">
                            <a href="/admin/deals/addcategory/section_id/<?php echo $this->_tpl_vars['section_id']; ?>
...
?>
                                <tr>
                                    ...
                                    <td class="span3" style="text-align: center; vertical-align: middle;">
                                        <a href="/admin/deals/modifycategory/id/<?php echo $this->_tpl_vars['item']['id']; ?>
/section_id/<?php echo $this->_tpl_vars['section_id']; ?>
/spage/<?php echo $this->_tpl_vars['spage']; ?>
"><?php echo $this->_tpl_vars['adminLangParams']['ACTION_EDIT']; ?>
</a>
                                        &nbsp;|&nbsp;
                                        <a href="/admin/deals/deletecategory/id/<?php echo $this->_tpl_vars['item']['id']; ?>
/section_id/<?php echo $this->_tpl_vars['section_id']; ?>
/spage/<?php echo $this->_tpl_vars['spage']; ?>
...
$this->_smarty_include(array('smarty_include_tpl_file' => 'admin/deals/categories/paging.tpl', 'smarty_include_vars' => array()));
