<?php /* Smarty version 2.6.18, created on 2014-02-06 14:46:16
         compiled from admin/deals/categories/add_modify_item.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'stripslashes', 'admin/deals/categories/add_modify_item.tpl', 60, false),)), $this); ?>
...
/spage/1/page/1">Категории</a>
                ...
                <li>
                    <a href="javascript:void(0);"><?php if ($this->_tpl_vars['action'] == 'modifycategory'): ?>Изменение<?php else: ?>Добавление<?php endif; ?> категории</a>
                </li>
            </ul>
        </div>
    </div>
...
" />
                                        ...
                                        <button type="button" class="btn" onclick="document.location.href='/admin/deals/categories/section_id/<?php echo $this->_tpl_vars['section_id']; ?>
