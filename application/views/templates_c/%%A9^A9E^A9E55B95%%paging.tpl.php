<?php /* Smarty version 2.6.18, created on 2014-02-06 19:39:06
         compiled from admin/articles/categories/paging.tpl */ ?>
        ...
        <div class="span12">
            <div class="pagination" style="margin-top: 15px; margin-bottom: 0px;">
                <ul>
                    ...
                    <?php else: ?>
                        <li class="prev"><a href="/admin/articles/categories/section_id/<?php echo $this->_tpl_vars['section_id']; ?>
...
?>
                        ...
                        <?php else: ?>
                            <li><a href="/admin/articles/categories/section_id/<?php echo $this->_tpl_vars['section_id']; ?>
/spage/<?php echo $this->_tpl_vars['spage']; ?>
...
"><?php echo $this->_sections['item']['index']; ?>
                    ...
                    <?php else: ?>
                        <li class="next"><a href="/admin/articles/categories/section_id/<?php echo $this->_tpl_vars['section_id']; ?>
/spage/<?php echo $this->_tpl_vars['spage']; ?>
/page/<?php echo $this->_tpl_vars['page']+1; ?>
