<?php /* Smarty version 2.6.18, created on 2014-02-18 18:05:26
         compiled from admin/products/paging.tpl */ ?>
        ...
        <div class="span12">
            <div class="pagination" style="margin-top: 15px; margin-bottom: 0px;">
                <ul>
                    ...
                    <?php else: ?>
                        <li class="prev"><a href="/admin/products/index/section/<?php echo $this->_tpl_vars['curr_section']; ?>
/category/<?php echo $this->_tpl_vars['curr_category']; ?>
...
?>
                        ...
                        <?php else: ?>
                            <li><a href="/admin/products/index/section/<?php echo $this->_tpl_vars['curr_section']; ?>
/category/<?php echo $this->_tpl_vars['curr_category']; ?>
...
"><?php echo $this->_sections['item']['index']; ?>
                    ...
                    <?php else: ?>
                        <li class="next"><a href="/admin/products/index/section/<?php echo $this->_tpl_vars['curr_section']; ?>
/category/<?php echo $this->_tpl_vars['curr_category']; ?>
/page/<?php echo $this->_tpl_vars['page']+1; ?>
