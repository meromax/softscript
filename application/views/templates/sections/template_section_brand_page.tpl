...
<div class="highslide-gallery">
    ...
    <div class="paginator">
        {section name=item start=1 loop=$page_count+1 }
            ...
            {else}
                <a href="/catalog/sec/{$activeLeftSection}/brand/{$brandLink}/page/{$smarty.section.item.index}"><div class="point">{$smarty.section.item.index}</div></a>
            {/if}
        {/section}
    </div>
    {/if}
    ...
    <div class="archive">
        <a href="/archive/sec/{$secLink}/brand/{$brandLink}/page/1">Архив товаров</a>
    </div>
