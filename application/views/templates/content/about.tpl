        ...
        <div class="row">
                    ...
                    <div class="row">
                        <div class="span3" id="spyMenu">
                            <ul class="nav nav-pills nav-stacked">
                                <li class="active"><a href="#jaka">Алексей Граков <i class="icon-caret-right pull-right"></i></a></li>
                                <li><a href="#primoz">Морган Фримен <i class="icon-caret-right pull-right"></i></a></li>
                                <li><a href="#ana">Анджелина Джоли <i class="icon-caret-right pull-right"></i></a></li>
                                <li><a href="#andre">Анатолий Вассерман <i class="icon-caret-right pull-right"></i></a></li>
                            </ul>
                        </div>
                    </div>
            ...
            <section class="span9">
                ...
                <div class="underlined push-down-20">
                    <h3><span class="light">Несколько слов</span> о нас</h3>
                </div> <!-- /title -->
                ...
                <section>
                    ...
                    <div class="row-fluid push-down-20" id="jaka">
                        ...
                        <div class="span4">
                            <h4><span class="light">Алексей</span> Граков</h4>
                            <h6 class="move-title-up">Генеральный директор</h6>
                    ...
                    <div class="row-fluid push-down-20" id="primoz">
                        ...
                        <div class="span4">
                            <h4><span class="light">Морган</span> Фримен</h4>
                            <h6 class="move-title-up">Технический директор</h6>
                            <p>Lorem ipsum dolor sit amet, coetur adipiscing elit. Ut feugiat mauris et magna egestas porta. Curabiturittis sagittis neque rutrum congue. Dec lobortis dui sagittis, ultrices nuncre, ultricies elit. Curabitur tristique felis pulvinar nibh porta, sit amet inteum ligula placerat. Maecenas auctor, sem nec eleifend blandit. Lorem ipsum dolor sit amet.</p>
                        </div>
                        <div class="span4">
                    ...
                    <div class="row-fluid push-down-20" id="ana">
                        ...
                        <div class="span4">
                            <h4><span class="light">Анджелина</span> Джоли</h4>
                            <h6 class="move-title-up">Секретарша</h6>
                            <p>Lorem ipsum dolor sit amet, coetur adipiscing elit. Ut feugiat mauris et magna egestas porta. Curabiturittis sagittis neque rutrum congue. Dec lobortis dui sagittis, ultrices nuncre, ultricies elit. Curabitur tristique felis pulvinar nibh porta, sit amet inteum ligula placerat. Maecenas auctor, sem nec eleifend blandit. Lorem ipsum dolor sit amet.</p>
                        </div>
                        <div class="span4">
                            <blockquote>
                    ...
                    <div class="row-fluid push-down-20" id="andre">
                        ...
                        <div class="span4">
                            <h4><span class="light">Анатолий</span> Вассерман</h4>
                            <h6 class="move-title-up">Ботан-челове-паук</h6>
                            <p>Lorem ipsum dolor sit amet, coetur adipiscing elit. Ut feugiat mauris et magna egestas porta. Curabiturittis sagittis neque rutrum congue. Dec lobortis dui sagittis, ultrices nuncre, ultricies elit. Curabitur tristique felis pulvinar nibh porta, sit amet inteum ligula placerat. Maecenas auctor, sem nec eleifend blandit. Lorem ipsum dolor sit amet.</p>
                        </div>
                        <div class="span4">
