                ...
                <div class="row" style="min-height: 400px;">
                    <div class="span10 offset1">
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            {*<tr onclick="$('#payment_method2').prop('checked',true);" style="cursor: pointer;">*}
                                {*<td style="width: 20px; text-align: center; vertical-align: middle;"><input type="radio" name="payment_method" id="payment_method2" value="paypal" /></td>*}
