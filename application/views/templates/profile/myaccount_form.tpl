<div class="centercol">
	<div class="title">
		...
		<h2><p style="font-family:Verdana; padding-top:3px; font-size:23px; font-weight:normal; color:#ffffff;">My Account</p></h2>
	...
	<div class="content laf">
		...
		<form method="post" action="/myaccount/index/index" name="account_form">
         <div class="billing">
            ...
            <div class="cleaner"><!-- --></div>
         	...
         	<input type="text" name="member_firstname" id="member_firstname" value="{$member->member_firstname|stripslashes}" class="text-input" />
            <div class="cleaner"><!-- --></div>
            
            <label>Last name:</label>
         	<input type="text" id="member_lastname" name="member_lastname" value="{$member->member_lastname|stripslashes}"  class="text-input" />
            <div class="cleaner"><!-- --></div>
            
            <label>E-mail:</label>
         	<input type="text" name="member_email" id="member_reg_email" class="text-input" value="{$member->member_email|stripslashes}" style="width: 200px;" /> <span style="color:#DF0A07;">*</span>
            <div class="cleaner"><!-- --></div>
            
            <label>Password:</label>
         	<input type="password" name="member_password" id="member_reg_password" autocomplete="off" class="text-input" value="" style="width: 160px;" /> <span style="color:#DF0A07;">*</span>
            <div class="cleaner"><!-- --></div>
            
            <label>Password again:</label>
         	<input type="password" name="member_re_password" id="member_reg_re_password" autocomplete="off" class="text-input" style="width: 160px;" /> <span style="color:#DF0A07;">*</span>
            <div class="cleaner"><!-- --></div>
            
                        
            <label>Phone:</label>
         	<input type="text" name="member_phone" id="member_phone" value="{$member->member_phone|stripslashes}" class="text-input" maxlength="12" style="width: 160px;" />
            <div class="cleaner"><!-- --></div>
            ...
            <div style="padding: 15px 0 50px 150px; text-align:left;">
            	<div class="button-line" style="margin:0px 0px 0px 0px;">
	            	...
	            	<input class="updateb" type="button" value="" onclick="checkUpdateForm();" />
...
{literal}
	<script type="text/javascript">
		...
		var	msg = "- <span style='padding:3px 3px 3px 3px; color:green; font-size:12px;'>{/literal}{$mess}{literal}</span>";
		$("#message_text2").html(msg);
		$("#message_box2").fadeIn({"opacity": "show" }, { "duration": "slow", "easing": "easein" });
		
		setTimeout(function(){
		
			$("#message_box2").fadeOut("slow");
		}, 
		2000);
...
<script type="text/javascript">
	...
	document.getElementById('member_reg_password').value = "";
	document.getElementById('member_reg_re_password').value = "";
...
function checkUpdateForm(){
	...
	if(msg==''){
		...
		var url = "email="+member_email.value; 
		$.ajax({
		type: "POST",
		url: "/myaccount/index/checkemail",
		data: url,
		success: function(data){
			$("#progress1").hide();
			
			if(data=='1'){
				msg = "- <span style='padding:3px 3px 3px 3px; color:black; font-size:12px;'>The email already exists</span>";
