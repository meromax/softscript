            ...
            <div class="span12">
                <div class="portlet box grey">
                    ...
                    <div class="portlet-body">
                            ...
                            {foreach from=$sections item=item}
                                <tr>
                                    ...
                                    <td class="span3" style="text-align: center; vertical-align: middle;">
                                        <a href="/admin/sections/categories/section_id/{$item.id}/spage/{$page}/page/0">Изменить</a>
                                    </td>
                                    <td class="span3" style="text-align: center; vertical-align: middle;">
                                        <a href="/admin/sections/modifysection/id/{$item.id}">Изменить</a>
                                        &nbsp;|&nbsp;
                                        <a href="/admin/sections/deletesection/id/{$item.id}" onclick="return confirm('Вы уверены, что хотите удалить эту запись?')">Удалить</a>
                                    </td>
                                </tr>
                                {foreachelse}
                                <tr>
                        ...
                        {include file='admin/sections/sections/paging.tpl'}
