<div class="portlet box yellow" style="margin-top: 20px;">
    ...
    <div class="portlet-body" style="padding-top: 20px; padding-left: 20px;">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" name="meta_title" id="meta_title" value="{$page.meta_title|stripslashes}" class="span6 m-wrap" />
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" name="meta_description" id="meta_description" value="{$page.meta_description|stripslashes}" class="span6 m-wrap" />
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" name="meta_keywords" id="meta_keywords" value="{$page.meta_keywords|stripslashes}" class="span6 m-wrap" />
            </div>
        </div>
    </div>
</div>