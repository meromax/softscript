<div class="container-fluid">
    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            <h3 class="page-title">
                {if $action == 'modifycompany'}Изменение{else}Добавление{/if} компании <small>&nbsp;</small>
            </h3>
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="javascript:void(0);">{if $action == 'modifycompany'}Изменение{else}Добавление{/if} компании</a>
                </li>
            </ul>
        </div>
    </div>
            ...
            <div class="span12">
                ...
                <div class="portlet box grey">
                    <div class="portlet-title">
                        <div class="caption">{if $action == 'modifycompany'}<i class="icon-pencil"></i> Изменение{else}<i class="icon-plus"></i> Добавление{/if} компании</div>
                    </div>
