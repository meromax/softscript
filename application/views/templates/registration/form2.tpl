...
<tr>
	<td width="280" style="padding:5px 5px 5px 5px;">
		<table align="center" border="0">
			...
			<tr>
				...
				<td style="padding:5px 0px 5px 0px;"><input type="text" id="registration_lastname" name="registration_lastname" value="" autocomplete="off" class="input_edit" /></td>
			</tr>
			<tr>
				...
				<td style="padding:5px 0px 5px 0px;"><input type="text" id="registration_company" name="registration_company" value="" autocomplete="off" class="input_edit" /></td>
			</tr>
			<tr>
				...
				<td style="padding:5px 0px 5px 0px;"><input type="text" id="registration_phone" name="registration_phone" value="" autocomplete="off" class="input_edit" /></td>
			</tr>
			<tr>
				...
				<td style="padding:5px 0px 5px 0px;"><input type="text" id="registration_url" name="registration_url" value="" autocomplete="off" class="input_edit" /></td>
			</tr>
			<tr>
	...
	<td valign="top">
		...
		<div id="message_box2" style="margin-top:11px; color:#666666; background:#ffffff; width:190px; display:none; border:1px solid #B3C6D3;">
		...
		<div id="progress2" style="position:absolute; background:#ECF0FB; margin-left:30px; margin-top:50px; text-align:center; display:none;  z-index:1001;">
