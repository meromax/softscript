			...
			<div class="gl_block_pos">
					...
					<div class="profile">
						<form method="POST" action="/orders/index/save" id="order_preview_form">
								...
								<p class="zakaz_cost">{$frontendLangParams.TITLE__COST}<b>$ {if isset($order.totalPrice) && isset($order.totalPrice2)}{$order.totalPrice} + {else} {$order.totalPrice} {/if}{$order.totalPrice2}</b></p>
