<div class="cont_l">
		...
		<div class="kalk">
			...
			<div class="kalk_pos">
				<form method="POST" action="" name="translation_form" id="translation_form" enctype="multipart/form-data">
					<div class="txt_pos">
						<div style="position:absolute; align:right; z-index:4; cursor:arrow; cursor:arrow;">
							<input type="file" name="file" id="file" style="z-index:4; -moz-opacity:0; filter:alpha(opacity: 0); cursor:arrow; cursor:arrow; overflow: hidden; width:118px; margin-left:168px; height:22px; opacity:0; border:1px solid #000000;" />
						</div>
						<span class="sbm_button" style="z-index:3;"><input type="button" value="{$frontendLangParams.TITLE__ADD_FILE}" onclick="$('input[type=file]').click();"></span>
					...
					<div class="txt_pos">
						<span class="m_sbm">
						{if !$UserLogedIn}
							<a class="pop-up-box-link" href="#bl_auth" style="text-decoration:none;">
								<input  type="button" class="pop-up-box-link" value="{$frontendLangParams.TITLE__CALCULATE_THE_COST_OF}">
							</a>
						{else}
