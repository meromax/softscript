...
//            ||!$this->_hasParam('page')
//            ||(($this->_hasParam('page')&&$this->_getParam('page')>1) && ($this->sections->getSubSectionsAllPagesCount($this->lang_id)<=1 ))
//            ||($this->_getParam('page')>1&&$this->sections->getSubSectionsAllPagesCount($this->lang_id)<$this->_getParam('page'))
//        ){
...
//
//        $subSections = $this->sections->getSubSectionsAllForPage($this->lang_id, $page);
//
//        for($i=0; $i<sizeof($subSections); $i++){
//            $secData = $this->sections->getSectionById($subSections[$i]['section_id']);
//            $subSections[$i]['section_link'] = $secData['link'];
//        }
//
//        $this->smarty->assign('page_num', $page+1);
//        $this->smarty->assign('page_count', $this->sections->getSubSectionsAllPagesCount($this->lang_id));
//
//        $this->smarty->assign('subSections', $subSections);
//
//        $this->smarty->assign('meta_title', "Каталог театрльных товаров");
//        $this->smarty->assign('meta_keywords', "Каталог театрльных товаров");
//        $this->smarty->assign('meta_description', "Каталог театрльных товаров");
//
...
//        if( ($this->_hasParam('page')&&$this->_getParam('page')==0)
//            ||!$this->_hasParam('page')
//            ||(($this->_hasParam('page')&&$this->_getParam('page')>1) && ($this->sections->getSubSectionsCustomPagesCount($section['id'], $this->lang_id)<=1 ))
//            ||($this->_getParam('page')>1&&$this->sections->getSubSectionsCustomPagesCount($section['id'], $this->lang_id)<$this->_getParam('page'))
//        ){
//            //$this->_redirect("/catalog/page/1");
//        }
//
//        $page = $this->_hasParam('page')?((int)$this->_getParam('page')-1):0;
//        $subSections = $this->sections->getSubSectionsCustomForPage($section['id'], $this->lang_id, $page);
//        $this->smarty->assign('page_num', $page+1);
//        $this->smarty->assign('page_count', $this->sections->getSubSectionsCustomPagesCount($section['id'], $this->lang_id));
//
//        $this->smarty->assign('subSections', $subSections);
//
//        $this->smarty->assign('meta_title', "Мебельный каталог");
//        $this->smarty->assign('meta_keywords', "Мебельный каталог");
//        $this->smarty->assign('meta_description', "Мебельный каталог");
//
//        $this->smarty->assign('menuActive', "catalog");
//
//
...
//        $this->smarty->display('layouts/sub.tpl');
        ...
        $this->smarty->assign('PageBody', 'sections/catalog_section_new.tpl');
        $this->smarty->display('layouts/sub.tpl');
